        ...
        <div class="raised">
			...
			if ( 'amount' === $goal_format ) :
				...
				echo sprintf( /* translators: 1: amount of income raised 2: goal target amount. */
					__( '<span class="income">%1$s</span> of <span class="goal-text">%2$s</span> raised', 'revive-charity' ), give_currency_filter( $income, array( 'form_id' => $form_id ) ), give_currency_filter( $goal, array( 'form_id' => $form_id ) ) );

            elseif ( 'percentage' === $goal_format ) :

				echo '<span class="give-percentage">' . round( $progress ) . '%</span>';
            ...
            elseif ( 'donation' === $goal_format ) :
				...
				echo sprintf( /* translators: 1: total number of donations completed 2: total number of donations set as goal */
					_n( '<span class="income">%1$s</span> of <span class="goal-text">%2$s</span> donation', '<span class="income">%1$s</span> of <span class="goal-text">%2$s</span> donations', $goal, 'revive-charity' ), $income, $goal );
            ...
            elseif ( 'donors' === $goal_format ) :
				...
				echo sprintf( /* translators: 1: total number of donors completed 2: total number of donors set as goal */
					_n( '<span class="income">%1$s</span> of <span class="goal-text">%2$s</span> donation', '<span class="income">%1$s</span> of <span class="goal-text">%2$s</span> donors', $goal, 'revive-charity' ), $income, $goal );
