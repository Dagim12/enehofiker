...
$blog_section_readmore      = get_theme_mod( 'benevolent_blog_section_readmore', __( 'Read More', 'revive-charity' ) );
$blog_section_viewall       = get_theme_mod( 'revive_charity_blog_viewall', __( 'READ ALL BLOG', 'revive-charity' ) );
$blog_section_viewall_link  = get_theme_mod( 'revive_charity_blog_viewall_link' );
...
<?php } 
    ...
    <div class="blog-holder">
    				...
    				<div class="post">
                        ...
                        <?php 
                            if( has_post_thumbnail() ){ 
                                the_post_thumbnail( 'revive-charity-blog', array( 'itemprop' => 'image' ) ); 
                            }else{
                               benevolent_get_fallback_svg( 'revive-charity-blog' );
                            }
                        ?>
                        </a>
        ...
        <?php if( $blog_section_viewall && $blog_section_viewall_link ) echo '<a href="'. esc_url( $blog_section_viewall_link ) .'" class="btn-learn">'. esc_html( $blog_section_viewall ) .'</a>'; ?>
    </div>
    <?php }