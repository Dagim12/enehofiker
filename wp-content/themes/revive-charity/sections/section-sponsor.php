...
$sponsors = array(
    ...
    'six'   => array(
        'logo'  => get_theme_mod( 'benevolent_sponsor_logo_six' ),
        'url'   => get_theme_mod( 'benevolent_sponsor_logo_six_url' )
    ),
    'seven'   => array(
        'logo'  => get_theme_mod( 'benevolent_sponsor_logo_seven' ),
        'url'   => get_theme_mod( 'benevolent_sponsor_logo_seven_url' )
    ),
    'eight'   => array(
        'logo'  => get_theme_mod( 'benevolent_sponsor_logo_eight' ),
        'url'   => get_theme_mod( 'benevolent_sponsor_logo_eight_url' )
    )
);
