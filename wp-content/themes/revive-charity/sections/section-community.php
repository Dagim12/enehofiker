...
$community_learn_more    = get_theme_mod( 'revive_charity_community_readmore', __( 'LEARN MORE', 'revive-charity' ) );
                        ...
                        <div class="table-row">
                            <div class="table-cell">
                                ...
                                if( has_excerpt() ){ 
                                    ...
                                    echo wpautop( wp_kses_post( wp_trim_words( strip_shortcodes( get_the_content() ), 55, '&hellip;' ) ) );    
                                }
                                if( $community_learn_more ) echo '<a href="' . esc_url( get_permalink() ) . '" class="btn-learn">' . esc_html( $community_learn_more ) . '</a>'; ?>
